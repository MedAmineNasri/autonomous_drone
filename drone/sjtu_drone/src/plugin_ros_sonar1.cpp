#include "plugin_ros_sonar1.h"
//#include "gazebo/sensors/ImuSensor.hh"
#include "gazebo/sensors/SonarSensor.hh"
namespace gazebo{
void RosSonarPlugin1::Load(sensors::SensorPtr _sensor, sdf::ElementPtr /*_sdf*/){
    ...
    ROS_INFO("The Right Sonar plugin has been loaded!");
    ...
    this->updated_conn_ = this->sonar_->ConnectUpdated(
                boost::bind(&RosSonarPlugin1::onUpdated,this));
...
void RosSonarPlugin1::onUpdated(){
    //copy data into ros message

    sonar_msg_.header.frame_id = "sonar_r";
...
GZ_REGISTER_SENSOR_PLUGIN(RosSonarPlugin1)
}
