#include "plugin_ros_sonar3.h"
//#include "gazebo/sensors/ImuSensor.hh"
#include "gazebo/sensors/SonarSensor.hh"
namespace gazebo{
void RosSonarPlugin3::Load(sensors::SensorPtr _sensor, sdf::ElementPtr /*_sdf*/){
    ...
    ROS_INFO("The Left Sonar plugin has been loaded!");
    ...
    this->updated_conn_ = this->sonar_->ConnectUpdated(
                boost::bind(&RosSonarPlugin3::onUpdated,this));
}
...
void RosSonarPlugin3::onUpdated(){
    //copy data into ros message

    sonar_msg_.header.frame_id = "sonar_l";
...
GZ_REGISTER_SENSOR_PLUGIN(RosSonarPlugin3)
}
