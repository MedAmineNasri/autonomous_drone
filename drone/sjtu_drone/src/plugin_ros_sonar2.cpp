#include "plugin_ros_sonar2.h"
//#include "gazebo/sensors/ImuSensor.hh"
#include "gazebo/sensors/SonarSensor.hh"
namespace gazebo{
void RosSonarPlugin2::Load(sensors::SensorPtr _sensor, sdf::ElementPtr /*_sdf*/){
    ...
    ROS_INFO("The backward Sonar plugin has been loaded!");
    ...
    this->updated_conn_ = this->sonar_->ConnectUpdated(
                boost::bind(&RosSonarPlugin2::onUpdated,this));
}
...
void RosSonarPlugin2::onUpdated(){
    //copy data into ros message

    sonar_msg_.header.frame_id = "sonar_b";
...
GZ_REGISTER_SENSOR_PLUGIN(RosSonarPlugin2)
}
